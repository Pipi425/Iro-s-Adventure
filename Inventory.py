...
class Consumable(Item):
    def __init__(self, name, image_path, description, heal=0, quantity=1):
        super().__init__(name, image_path, description, "consumable", quantity)
        self.heal = heal
        self.quantity = quantity
...
class Inventory:
    ...
    def load(self, data):
        ...
        from SaveSystem import create_item_by_name
...
class InventoryUI:
    ...
    def draw_status(self, screen):
        ...
        screen.blit(
            ...
            (self.left_x + 20, self.y + 120)
        )

        screen.blit(
            font.render("Bow", True, (255, 255, 255)),
            (self.left_x + 120, self.y + 120)
        )

        weapon_pos = (self.left_x + 20, self.y + 160)
        bow_pos = (self.left_x + 120, self.y + 160)
    ...
    def draw_equipment(self, screen):
        ...
        screen.blit(
            ...
            (self.right_x + 120, self.y + 120)
        )

        head_pos = (self.right_x + 20, self.y + 70)
        chest_pos = (self.right_x + 20, self.y + 160)

        hand_pos = (self.right_x + 120, self.y + 70)
        leg_pos = (self.right_x + 120, self.y + 160)
