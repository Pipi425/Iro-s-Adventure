...
class SkeletonBoxer:
    def __init__(self, x, y):
        ...
        self.hit1_done = False
        self.hit2_done = False
        ...
        self.die_sound = pygame.mixer.Sound(
            "SkeletonBoxer/Sounds/Die.mp3"
        )

        self.hurt_sound = pygame.mixer.Sound(
            "SkeletonBoxer/Sounds/Hurt.mp3"
        )

        self.sword_sound_1 = pygame.mixer.Sound(
            "SkeletonBoxer/Sounds/Sword1.mp3"
        )

        self.sword_sound_2 = pygame.mixer.Sound(
            "SkeletonBoxer/Sounds/Sword2.mp3"
        )

        self.walk_sound = pygame.mixer.Sound("SkeletonBoxer/Sounds/Walk.mp3")
        self.walk_sound.set_volume(0.4)

        self.walk_sound_timer = 0

        self.sword_sound_1.set_volume(0.3)
        self.sword_sound_2.set_volume(0.3)
    ...
    def hit_player(self, player):
        ...
        if self.dagger_frame == 4:
            self.sword_sound_1.play()
        elif self.dagger_frame == 6:
            self.sword_sound_2.play()

        attack_rect = self.get_attack_rect()

        # 第一刀
        if self.dagger_frame == 4 and not self.hit1_done:
        ...
        # 第二刀
        if self.dagger_frame == 6 and not self.hit2_done:
