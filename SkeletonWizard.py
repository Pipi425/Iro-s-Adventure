...
class WizardProjectile:
    def __init__(self, x, y, target_x, target_y, images):
        ...
        self.hit_sound = pygame.mixer.Sound("SkeletonWizard/Sounds/Hit.mp3")
...
class SkeletonWizard:
    def __init__(self, x, y):
        ...
        self.fire_sound = pygame.mixer.Sound("SkeletonWizard/Sounds/Fire.mp3")
        self.magiccircle_sound = pygame.mixer.Sound("SkeletonWizard/Sounds/MagicCircle.mp3")
        ...
        self.magiccircle_sound.set_volume(0.6)
